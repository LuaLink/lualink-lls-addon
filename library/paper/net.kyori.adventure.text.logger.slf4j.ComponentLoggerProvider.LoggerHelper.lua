...
---@class net.kyori.adventure.text.logger.slf4j.ComponentLoggerProvider.LoggerHelper: java.lang.Object
local LoggerHelper = {}

---@public
---@return function a plain serializer
...
---@param serializer function the serializer to translate and format a component in a log message.
---@public
