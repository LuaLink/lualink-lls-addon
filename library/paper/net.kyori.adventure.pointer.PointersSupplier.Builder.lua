...
---@class net.kyori.adventure.pointer.PointersSupplier.Builder: net.kyori.adventure.builder.AbstractBuilder
local Builder = {}

---@param parent net.kyori.adventure.pointer.PointersSupplier the parent
---@public
...
---@param resolver java.util.function.Function the resolver
---@public
---@return net.kyori.adventure.pointer.PointersSupplier.Builder this builder
