...
---@overload fun(player: Player, viewers: table<Audience>, renderer: ChatRenderer, message: Component, originalMessage: Component, signedMessage: SignedMessage): io.papermc.paper.event.player.ChatEvent
local ChatEvent = {}
