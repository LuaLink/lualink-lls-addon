...
---| '"net.kyori.adventure.text.event.ClickEvent.Payload.Dialog"' 
...
---| '"net.kyori.adventure.text.event.PayloadImpl"' 
...
---| '"net.kyori.adventure.text.flattener.ComponentFlattenerImpl.StackEntry"' 
...
---| '"net.kyori.adventure.platform.bukkit.BukkitEmitter"' 
...
---| '"net.kyori.adventure.platform.bukkit.BukkitFacet.ViaHook"' 
...
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitAccess.Chat1_19_3"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitAccess.EntitySound"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitAccess.EntitySound_1_19_3"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitAccess.Book_1_20_5"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitAccess"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitFacet.PacketFacet"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitFacet.Chat1_19_3"' 
...
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitFacet.AbstractBook.TrustedByteArrayOutputStream"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitFacet.AbstractBook"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitFacet.BookPost1_13"' 
---| '"net.kyori.adventure.platform.bukkit.CraftBukkitFacet.Book1_13"' 
...
---| '"net.kyori.adventure.platform.bukkit.SpigotFacet.ActionBar"' 
...
---| '"net.kyori.adventure.text.minimessage.MiniMessageImpl.Instances"' 
...
---| '"net.kyori.adventure.text.minimessage.MiniMessageSerializer.Collector.TagState"' 
...
---| '"net.kyori.adventure.text.minimessage.internal.parser.TokenParser.FirstPassState"' 
---| '"net.kyori.adventure.text.minimessage.internal.parser.TokenParser.TagProvider"' 
---| '"net.kyori.adventure.text.minimessage.internal.parser.TokenParser.SecondPassState"' 
...
---| '"net.kyori.adventure.text.minimessage.translation.LocalePointered"' 
...
---| '"net.kyori.adventure.text.serializer.gson.GsonComponentSerializerImpl.Instances"' 
...
---| '"net.kyori.adventure.text.serializer.gson.GsonDataComponentValueImpl.RemovedGsonComponentValueImpl"' 
...
---| '"co.aikar.timings.TimingHistory.PingRecord"' 
...
---| '"io.papermc.paper.plugin.lifecycle.event.types.LifecycleEventType.Monitorable"' 
...
---| '"io.papermc.paper.registry.data.dialog.DialogBase.DialogAfterAction"' 
...
---| '"io.papermc.paper.registry.holder.RegistryHolder.Reference"' 
---| '"io.papermc.paper.registry.holder.RegistryHolder.Inlined"' 
...
---| '"org.bukkit.plugin.java.JavaPlugin.DummyPluginLoaderImplHolder"' 
