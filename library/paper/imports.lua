...
---| '"net.kyori.adventure.internal.properties.Property"' 
---| '"net.kyori.adventure.internal.properties.AdventureProperties"' 
---| '"net.kyori.adventure.internal.properties.PropertyImpl"' 
---| '"net.kyori.adventure.internal.properties.AdventurePropertiesImpl"' 
---| '"net.kyori.adventure.inventory.Builder"' 
---| '"net.kyori.adventure.inventory.Book"' 
---| '"net.kyori.adventure.inventory.BuilderImpl"' 
...
---| '"net.kyori.adventure.permission.Always"' 
...
---| '"net.kyori.adventure.pointer.Builder"' 
---| '"net.kyori.adventure.pointer.Pointers"' 
---| '"net.kyori.adventure.pointer.BuilderImpl"' 
---| '"net.kyori.adventure.pointer.PointersImpl"' 
---| '"net.kyori.adventure.pointer.Builder"' 
---| '"net.kyori.adventure.pointer.PointersSupplier"' 
---| '"net.kyori.adventure.pointer.ForwardingPointers"' 
---| '"net.kyori.adventure.pointer.BuilderImpl"' 
...
---| '"net.kyori.adventure.resource.Builder"' 
---| '"net.kyori.adventure.resource.ResourcePackInfo"' 
---| '"net.kyori.adventure.resource.BuilderImpl"' 
...
---| '"net.kyori.adventure.sound.Source"' 
---| '"net.kyori.adventure.sound.Type"' 
---| '"net.kyori.adventure.sound.Emitter"' 
---| '"net.kyori.adventure.sound.Builder"' 
---| '"net.kyori.adventure.sound.Sound"' 
---| '"net.kyori.adventure.sound.BuilderImpl"' 
---| '"net.kyori.adventure.sound.Eager"' 
---| '"net.kyori.adventure.sound.Lazy"' 
...
---| '"net.kyori.adventure.text.Type"' 
---| '"net.kyori.adventure.text.Builder"' 
---| '"net.kyori.adventure.text.Pos"' 
---| '"net.kyori.adventure.text.LocalPos"' 
---| '"net.kyori.adventure.text.Coordinate"' 
---| '"net.kyori.adventure.text.WorldPos"' 
---| '"net.kyori.adventure.text.BlockNBTComponent"' 
---| '"net.kyori.adventure.text.BuilderImpl"' 
---| '"net.kyori.adventure.text.LocalPosImpl"' 
---| '"net.kyori.adventure.text.CoordinateImpl"' 
---| '"net.kyori.adventure.text.WorldPosImpl"' 
---| '"net.kyori.adventure.text.Tokens"' 
...
---| '"net.kyori.adventure.text.KeybindLike"' 
---| '"net.kyori.adventure.text.Builder"' 
...
---| '"net.kyori.adventure.text.event.Builder"' 
---| '"net.kyori.adventure.text.event.Options"' 
---| '"net.kyori.adventure.text.event.Provider"' 
---| '"net.kyori.adventure.text.event.ClickCallback"' 
---| '"net.kyori.adventure.text.event.Fallback"' 
---| '"net.kyori.adventure.text.event.ClickCallbackInternals"' 
---| '"net.kyori.adventure.text.event.BuilderImpl"' 
---| '"net.kyori.adventure.text.event.ClickCallbackOptionsImpl"' 
---| '"net.kyori.adventure.text.event.Action"' 
---| '"net.kyori.adventure.text.event.ClickEvent"' 
---| '"net.kyori.adventure.text.event.TagSerializable"' 
---| '"net.kyori.adventure.text.event.Removed"' 
---| '"net.kyori.adventure.text.event.DataComponentValue"' 
---| '"net.kyori.adventure.text.event.DataComponentValueConversionImpl"' 
---| '"net.kyori.adventure.text.event.Provider"' 
---| '"net.kyori.adventure.text.event.Conversion"' 
---| '"net.kyori.adventure.text.event.ConversionCache"' 
---| '"net.kyori.adventure.text.event.RegisteredConversion"' 
---| '"net.kyori.adventure.text.event.DataComponentValueConverterRegistry"' 
---| '"net.kyori.adventure.text.event.ShowItem"' 
---| '"net.kyori.adventure.text.event.ShowEntity"' 
---| '"net.kyori.adventure.text.event.Renderer"' 
---| '"net.kyori.adventure.text.event.Action"' 
...
---| '"net.kyori.adventure.text.flattener.Builder"' 
---| '"net.kyori.adventure.text.flattener.ComponentFlattener"' 
---| '"net.kyori.adventure.text.flattener.Handler"' 
---| '"net.kyori.adventure.text.flattener.BuilderImpl"' 
---| '"net.kyori.adventure.text.flattener.ComponentFlattenerImpl"' 
---| '"net.kyori.adventure.text.flattener.FlattenerListener"' 
---| '"net.kyori.adventure.text.format.EntrySet"' 
---| '"net.kyori.adventure.text.format.Values"' 
---| '"net.kyori.adventure.text.format.KeySet"' 
...
---| '"net.kyori.adventure.text.format.Builder"' 
...
---| '"net.kyori.adventure.text.format.BuilderImpl"' 
...
---| '"net.kyori.adventure.title.Times"' 
---| '"net.kyori.adventure.title.Title"' 
---| '"net.kyori.adventure.title.TimesImpl"' 
---| '"net.kyori.adventure.title.TitleImpl"' 
---| '"net.kyori.adventure.title.TitlePart"' 
---| '"net.kyori.adventure.translation.Translation"' 
---| '"net.kyori.adventure.translation.StringBased"' 
...
---| '"net.kyori.adventure.util.Builder"' 
---| '"net.kyori.adventure.util.Buildable"' 
---| '"net.kyori.adventure.util.Decoder"' 
---| '"net.kyori.adventure.util.Encoder"' 
...
---| '"net.kyori.adventure.util.BuilderImpl"' 
...
---| '"net.kyori.adventure.util.Fallback"' 
...
---| '"net.kyori.adventure.text.logger.slf4j.LoggerHelper"' 
---| '"net.kyori.adventure.text.logger.slf4j.ComponentLoggerProvider"' 
---| '"net.kyori.adventure.text.logger.slf4j.DefaultProvider"' 
---| '"net.kyori.adventure.text.logger.slf4j.LoggerHelperImpl"' 
...
---| '"net.kyori.adventure.text.minimessage.Builder"' 
---| '"net.kyori.adventure.text.minimessage.Provider"' 
---| '"net.kyori.adventure.text.minimessage.MiniMessage"' 
---| '"net.kyori.adventure.text.minimessage.Instances"' 
---| '"net.kyori.adventure.text.minimessage.BuilderImpl"' 
...
---| '"net.kyori.adventure.text.minimessage.Collector"' 
...
---| '"net.kyori.adventure.text.minimessage.internal.parser.TagProvider"' 
---| '"net.kyori.adventure.text.minimessage.internal.parser.SecondPassState"' 
...
---| '"net.kyori.adventure.text.minimessage.internal.serializer.Single"' 
...
---| '"net.kyori.adventure.text.minimessage.tag.AbstractTag"' 
...
---| '"net.kyori.adventure.text.minimessage.tag.Argument"' 
...
---| '"net.kyori.adventure.text.minimessage.tag.resolver.Single"' 
---| '"net.kyori.adventure.text.minimessage.tag.resolver.WithoutArguments"' 
---| '"net.kyori.adventure.text.minimessage.tag.resolver.Builder"' 
...
---| '"net.kyori.adventure.text.minimessage.tag.standard.ActionHandler"' 
---| '"net.kyori.adventure.text.minimessage.tag.standard.ShowText"' 
---| '"net.kyori.adventure.text.minimessage.tag.standard.ShowItem"' 
---| '"net.kyori.adventure.text.minimessage.tag.standard.ShowEntity"' 
...
---| '"net.kyori.adventure.text.minimessage.tree.Root"' 
...
---| '"net.kyori.adventure.text.serializer.gson.Builder"' 
---| '"net.kyori.adventure.text.serializer.gson.Provider"' 
---| '"net.kyori.adventure.text.serializer.gson.GsonComponentSerializer"' 
---| '"net.kyori.adventure.text.serializer.gson.Instances"' 
---| '"net.kyori.adventure.text.serializer.gson.BuilderImpl"' 
...
---| '"net.kyori.adventure.text.serializer.gson.RemovedGsonComponentValueImpl"' 
...
---| '"net.kyori.adventure.text.serializer.gson.Serializer"' 
...
---| '"co.aikar.timings.RegionId"' 
---| '"co.aikar.timings.RegionData"' 
---| '"co.aikar.timings.MinuteReport"' 
---| '"co.aikar.timings.TicksRecord"' 
---| '"co.aikar.timings.PingRecord"' 
---| '"co.aikar.timings.Counter"' 
---| '"co.aikar.timings.TimingHistory"' 
---| '"co.aikar.timings.TimingHistoryEntry"' 
---| '"co.aikar.timings.TimingGroup"' 
...
---| '"co.aikar.util.JSONPair"' 
---| '"co.aikar.util.JSONUtil"' 
---| '"co.aikar.util.Feeder"' 
---| '"co.aikar.util.LoadingIntMap"' 
---| '"co.aikar.util.AutoInstantiatingLoader"' 
---| '"co.aikar.util.Feeder"' 
---| '"co.aikar.util.LoadingMap"' 
---| '"co.aikar.util.MRUMapCache"' 
---| '"com.destroystokyo.paper.ChatVisibility"' 
---| '"com.destroystokyo.paper.ParticleVisibility"' 
...
---| '"com.destroystokyo.paper.Builder"' 
...
---| '"com.destroystokyo.paper.entity.PathResult"' 
...
---| '"com.destroystokyo.paper.event.entity.Reason"' 
...
---| '"com.destroystokyo.paper.event.player.Cause"' 
...
---| '"com.destroystokyo.paper.event.server.Completion"' 
---| '"com.destroystokyo.paper.event.server.CompletionImpl"' 
---| '"com.destroystokyo.paper.event.server.AsyncTabCompleteEvent"' 
---| '"com.destroystokyo.paper.event.server.QueryType"' 
---| '"com.destroystokyo.paper.event.server.Builder"' 
---| '"com.destroystokyo.paper.event.server.PluginInformation"' 
---| '"com.destroystokyo.paper.event.server.QueryResponse"' 
---| '"com.destroystokyo.paper.event.server.GS4QueryEvent"' 
---| '"com.destroystokyo.paper.event.server.PlayerIterator"' 
---| '"com.destroystokyo.paper.event.server.UncheckedPlayerProfile"' 
...
---| '"com.destroystokyo.paper.util.DummyVersionFetcher"' 
...
---| '"io.papermc.paper.chat.Default"' 
---| '"io.papermc.paper.chat.ViewerUnaware"' 
...
---| '"io.papermc.paper.command.brigadier.argument.Converted"' 
...
---| '"io.papermc.paper.datacomponent.Valued"' 
---| '"io.papermc.paper.datacomponent.NonValued"' 
...
---| '"io.papermc.paper.datacomponent.item.Builder"' 
...
---| '"io.papermc.paper.datacomponent.item.Entry"' 
---| '"io.papermc.paper.datacomponent.item.Builder"' 
...
---| '"io.papermc.paper.datacomponent.item.DecorationEntry"' 
---| '"io.papermc.paper.datacomponent.item.Builder"' 
...
---| '"io.papermc.paper.datacomponent.item.Rule"' 
---| '"io.papermc.paper.datacomponent.item.Builder"' 
...
---| '"io.papermc.paper.datacomponent.item.consumable.TeleportRandomly"' 
---| '"io.papermc.paper.datacomponent.item.consumable.RemoveStatusEffects"' 
---| '"io.papermc.paper.datacomponent.item.consumable.PlaySound"' 
---| '"io.papermc.paper.datacomponent.item.consumable.ClearAllStatusEffects"' 
---| '"io.papermc.paper.datacomponent.item.consumable.ApplyStatusEffects"' 
...
---| '"io.papermc.paper.datapack.Compatibility"' 
---| '"io.papermc.paper.datapack.Position"' 
---| '"io.papermc.paper.datapack.Datapack"' 
---| '"io.papermc.paper.datapack.DatapackManager"' 
---| '"io.papermc.paper.datapack.Configurer"' 
...
---| '"io.papermc.paper.entity.EntityState"' 
...
---| '"io.papermc.paper.event.entity.EquipmentChange"' 
...
---| '"io.papermc.paper.event.entity.Cause"' 
...
---| '"io.papermc.paper.event.player.PageChangeDirection"' 
...
---| '"io.papermc.paper.event.server.WhitelistStatus"' 
...
---| '"io.papermc.paper.plugin.lifecycle.event.registrar.Cause"' 
---| '"io.papermc.paper.plugin.lifecycle.event.registrar.ReloadableRegistrarEvent"' 
---| '"io.papermc.paper.plugin.lifecycle.event.types.Monitorable"' 
---| '"io.papermc.paper.plugin.lifecycle.event.types.Prioritizable"' 
...
---| '"io.papermc.paper.registry.data.Builder"' 
---| '"io.papermc.paper.registry.data.EnchantmentCost"' 
...
---| '"io.papermc.paper.threadedregions.scheduler.ExecutionState"' 
---| '"io.papermc.paper.threadedregions.scheduler.ScheduledTask"' 
---| '"io.papermc.paper.util.JarManifests"' 
---| '"io.papermc.paper.util.Tick"' 
---| '"io.papermc.paper.util.TransformedListIterator"' 
...
---| '"org.bukkit.SimpleRegistry"' 
---| '"org.bukkit.NotARegistry"' 
---| '"org.bukkit.Registry"' 
---| '"org.bukkit.Rotation"' 
...
---| '"org.bukkit.EntityDestination"' 
---| '"org.bukkit.BlockDestination"' 
---| '"org.bukkit.Destination"' 
---| '"org.bukkit.Vibration"' 
---| '"org.bukkit.WarningState"' 
---| '"org.bukkit.WeatherType"' 
---| '"org.bukkit.Environment"' 
---| '"org.bukkit.ChunkLoadCallback"' 
---| '"org.bukkit.Spigot"' 
---| '"org.bukkit.World"' 
...
---| '"org.bukkit.block.data.type.State"' 
...
---| '"org.bukkit.block.spawner.Equipment"' 
...
---| '"org.bukkit.configuration.file.ConstructCustomObject"' 
---| '"org.bukkit.configuration.file.YamlConstructor"' 
---| '"org.bukkit.configuration.file.RepresentConfigurationSection"' 
---| '"org.bukkit.configuration.file.RepresentConfigurationSerializable"' 
...
---| '"org.bukkit.conversations.NotPlayerMessagePrompt"' 
...
---| '"org.bukkit.entity.LockType"' 
---| '"org.bukkit.entity.ArmorStand"' 
---| '"org.bukkit.entity.Arrow"' 
---| '"org.bukkit.entity.Variant"' 
...
---| '"org.bukkit.entity.Variant"' 
---| '"org.bukkit.entity.SoundVariant"' 
...
---| '"org.bukkit.event.entity.ChangeReason"' 
...
---| '"org.bukkit.event.player.RecipeBookType"' 
...
---| '"org.bukkit.event.player.RespawnFlag"' 
...
---| '"org.bukkit.event.weather.Cause"' 
...
---| '"org.bukkit.generator.BiomeGrid"' 
---| '"org.bukkit.generator.ChunkData"' 
...
---| '"org.bukkit.help.TopicNameComparator"' 
...
---| '"org.bukkit.inventory.MaterialChoice"' 
---| '"org.bukkit.inventory.ExactChoice"' 
...
---| '"org.bukkit.inventory.meta.BookMetaBuilder"' 
---| '"org.bukkit.inventory.meta.Spigot"' 
...
---| '"org.bukkit.inventory.meta.components.ToolRule"' 
...
---| '"org.bukkit.inventory.meta.tags.PrimitiveTagType"' 
...
---| '"org.bukkit.map.CharacterSprite"' 
---| '"org.bukkit.map.MapFont"' 
---| '"org.bukkit.map.MapColorCache"' 
...
---| '"org.bukkit.permissions.RemoveAttachmentRunnable"' 
...
---| '"org.bukkit.persistence.ListPersistentDataTypeImpl"' 
...
---| '"org.bukkit.persistence.PrimitivePersistentDataType"' 
---| '"org.bukkit.persistence.BooleanPersistentDataType"' 
...
---| '"org.bukkit.plugin.java.DummyPluginLoaderImplHolder"' 
