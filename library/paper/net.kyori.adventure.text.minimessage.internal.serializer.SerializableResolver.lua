...
---@param componentClaim? java.util.function.Function the claim to test components against
---@public
...
---@param consumer net.kyori.adventure.text.minimessage.internal.serializer.ClaimConsumer a consumer for component claims, must not be stored
---@public
---@return nil 
