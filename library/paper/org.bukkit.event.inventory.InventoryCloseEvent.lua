...
---@overload fun(transaction: InventoryView): org.bukkit.event.inventory.InventoryCloseEvent
---@overload fun(transaction: InventoryView, reason: Reason): org.bukkit.event.inventory.InventoryCloseEvent
