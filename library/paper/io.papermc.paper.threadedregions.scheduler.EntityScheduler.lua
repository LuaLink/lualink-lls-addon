...
---@param run function The callback to run after the specified delay, may not be null.
---@param retired function Retire callback to run if the entity is retired before the run callback can be invoked, may be null.
