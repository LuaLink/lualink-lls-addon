...
---@class io.papermc.paper.registry.event.WritableRegistry: java.lang.Object
local WritableRegistry = {}

---@param key io.papermc.paper.registry.TypedKey the entry's key (must be unique from others)
---@param value function a consumer for the entry's builder
---@public
---@return nil 
...
---@param key io.papermc.paper.registry.TypedKey the entry's key (must be unique from others)
---@param value function a consumer of a builder factory
---@public
---@return nil 
