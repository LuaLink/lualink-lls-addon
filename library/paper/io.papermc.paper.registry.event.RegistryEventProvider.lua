...
---@public
---@return io.papermc.paper.plugin.lifecycle.event.types.LifecycleEventType.Prioritizable the registry freeze event type
--- Gets the event type for {@link RegistryComposeEvent} which is fired after a registry is loaded of expected elements. It allows for the registration of new objects. <p> Can be used in {@link io.papermc.paper.plugin.lifecycle.event.LifecycleEventManager#registerEventHandler(LifecycleEventType, LifecycleEventHandler)} to register a handler for {@link RegistryComposeEvent}.
function RegistryEventProvider:compose() end
