...
---@class org.bukkit.inventory.ItemType.Typed: org.bukkit.inventory.ItemType
local Typed = {}
...
---@param metaConfigurator java.util.function.Consumer an optional consumer of the items {@link ItemMeta} that is called.                         May be null if no intent exists to mutate the item meta at this point.
---@public
