...
---@class net.kyori.adventure.inventory.BookImpl: net.kyori.adventure.inventory.Book
...
---@overload fun(title: Component, author: Component, pages: table<Component>): net.kyori.adventure.inventory.BookImpl
local BookImpl = {}
