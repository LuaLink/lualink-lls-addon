...
---@public
---@return boolean 
--- Returns whether this skeleton horse is trapped. When a horse is trapped and a player comes within 10 blocks of a trapped horse, lightning will strike the horse. When struck, the skeleton trap will activate, turning the horse into a skeleton horseman as well as spawning three additional horsemen nearby.
function SkeletonHorse:isTrapped() end

---@param trapped boolean 
---@public
---@return nil 
