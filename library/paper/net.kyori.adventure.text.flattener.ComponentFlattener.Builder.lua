...
---@class net.kyori.adventure.text.flattener.ComponentFlattener.Builder: net.kyori.adventure.builder.AbstractBuilder, net.kyori.adventure.util.Buildable.Builder
local Builder = {}

---@param type java.lang.Class the component type
---@param converter java.util.function.Function the converter to map that component to a string
---@public
...
---@param type java.lang.Class the component type
---@param converter java.util.function.BiConsumer a provider of contained Components
---@public
---@return net.kyori.adventure.text.flattener.ComponentFlattener.Builder this builder
...
---@param converter java.util.function.Function the converter, may be null to ignore unknown components
---@public
---@return net.kyori.adventure.text.flattener.ComponentFlattener.Builder this builder
