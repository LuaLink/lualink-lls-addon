...
---@public
---@return Location 
--- Gets the treasure location this dolphin tries to guide players to. This value is calculated if the player has fed the dolphin a fish, and it tries to start the com.destroystokyo.paper.entity.ai.VanillaGoal#DOLPHIN_SWIM_TO_TREASURE goal.
function Dolphin:getTreasureLocation() end

---@param location Location 
---@public
---@return nil 
--- Sets the treasure location that this dolphin will try to lead the player to. This only has an effect if the dolphin is currently leading a player, as this value is recalculated next time it leads a player. The world of the location does not matter, as the dolphin will always use the world it is currently in.
