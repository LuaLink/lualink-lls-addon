...
---@overload fun(flatteners: InheritanceAwareMap<Component, Handler>, unknownHandler: Function<Component, String>): net.kyori.adventure.text.flattener.ComponentFlattenerImpl
