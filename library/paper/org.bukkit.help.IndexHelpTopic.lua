...
---@overload fun(name: string, shortText: string, permission: string, topics: java.util.Collection): org.bukkit.help.IndexHelpTopic
---@overload fun(name: string, shortText: string, permission: string, topics: java.util.Collection, preamble: string): org.bukkit.help.IndexHelpTopic
