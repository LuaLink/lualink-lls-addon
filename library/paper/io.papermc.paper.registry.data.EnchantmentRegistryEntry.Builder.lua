...
---@public
---@return io.papermc.paper.registry.data.EnchantmentRegistryEntry.Builder this builder instance.
--- Configures the set of supported items this enchantment can be applied on. This can be a {@link RegistryKeySet} created via {@link RegistrySet#keySet(io.papermc.paper.registry.RegistryKey, Iterable)} or a tag obtained via {@link RegistryComposeEvent#getOrCreateTag(TagKey)} with tag keys found in {@link io.papermc.paper.registry.keys.tags.ItemTypeTagKeys} such as {@link io.papermc.paper.registry.keys.tags.ItemTypeTagKeys#ENCHANTABLE_ARMOR} and {@link io.papermc.paper.registry.keys.tags.ItemTypeTagKeys#ENCHANTABLE_SWORD}.
...
---@public
---@return io.papermc.paper.registry.data.EnchantmentRegistryEntry.Builder this builder instance.
--- Configures a set of item types this enchantment can naturally be applied to, when enchanting in an enchantment table.This can be a {@link RegistryKeySet} created via {@link RegistrySet#keySet(io.papermc.paper.registry.RegistryKey, Iterable)} or a tag obtained via {@link RegistryComposeEvent#getOrCreateTag(TagKey)} with tag keys found in {@link io.papermc.paper.registry.keys.tags.ItemTypeTagKeys} such as {@link io.papermc.paper.registry.keys.tags.ItemTypeTagKeys#ENCHANTABLE_ARMOR} and {@link io.papermc.paper.registry.keys.tags.ItemTypeTagKeys#ENCHANTABLE_SWORD}. <p> Defaults to {@code null} which means all {@link #supportedItems()} are considered primary items. Additionally, the tag {@link io.papermc.paper.registry.keys.tags.EnchantmentTagKeys#IN_ENCHANTING_TABLE} defines which enchantments can even show up in an enchantment table.
