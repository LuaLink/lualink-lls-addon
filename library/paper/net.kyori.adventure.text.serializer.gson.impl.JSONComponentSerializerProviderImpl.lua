...
---@public
---@return any 
function JSONComponentSerializerProviderImpl:instance() end

---@public
---@return any 
function JSONComponentSerializerProviderImpl:builder() end

---@public
---@return string 
function JSONComponentSerializerProviderImpl:toString() end
