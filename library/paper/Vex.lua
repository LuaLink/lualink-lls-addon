...
---@public
---@return boolean 
--- Gets if this vex should start to take damage once Vex#getLimitedLifetimeTicks() is less than or equal to 0.
function Vex:hasLimitedLifetime() end

---@param hasLimitedLifetime boolean 
---@public
---@return nil 
--- Sets if this vex should start to take damage once Vex#getLimitedLifetimeTicks() is less than or equal to 0.
...
---@public
---@return nil 
--- Sets the number of ticks remaining until the vex takes damage. This number is ticked down only if Vex#hasLimitedLifetime() is true.
