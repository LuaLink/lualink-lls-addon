...
---@class java.util.function.Consumer: java.lang.Object
local Consumer = {}
...
---@public
---@return function a composed {@code Consumer} that performs in sequence this operation followed by the {@code after} operation
