...
---@class java.util.function.Function: java.lang.Object
local Function = {}
...
---@param before function the function to apply before this function is applied
---@public
---@return function a composed function that first applies the {@code before} function and then applies this function
...
---@public
---@return function a function that always returns its input argument
