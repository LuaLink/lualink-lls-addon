...
---@class java.util.function.Predicate: java.lang.Object
local Predicate = {}
...
---@param other function a predicate that will be logically-ANDed with this              predicate
---@public
---@return function a composed predicate that represents the short-circuiting logical AND of this predicate and the {@code other} predicate
...
---@public
---@return function a predicate that represents the logical negation of this predicate
--- Returns a predicate that represents the logical negation of this predicate.
function Predicate:negate() end

---@param other function a predicate that will be logically-ORed with this              predicate
---@public
---@return function a composed predicate that represents the short-circuiting logical OR of this predicate and the {@code other} predicate
...
---@public
---@return function a predicate that tests if two arguments are equal according to {@link Objects#equals(Object, Object)}
...
---@param target function predicate to negate
---@public
---@return function a predicate that negates the results of the supplied         predicate
