...
---@field private STATUS_POSITIVE number
---@field private STATUS_LENGTH number
---@field private digitList java.text.DigitList
---@field private positivePrefix string
---@field private positiveSuffix string
---@field private negativePrefix string
---@field private negativeSuffix string
---@field private posPrefixPattern string
---@field private posSuffixPattern string
---@field private negPrefixPattern string
---@field private negSuffixPattern string
---@field private multiplier number
---@field private groupingSize number
---@field private decimalSeparatorAlwaysShown boolean
---@field private parseBigDecimal boolean
---@field private isCurrencyFormat boolean
---@field private symbols java.text.DecimalFormatSymbols
---@field private useExponentialNotation boolean
---@field private positivePrefixFieldPositions java.text.FieldPosition
---@field private positiveSuffixFieldPositions java.text.FieldPosition
---@field private negativePrefixFieldPositions java.text.FieldPosition
---@field private negativeSuffixFieldPositions java.text.FieldPosition
---@field private minExponentDigits number
---@field private maximumIntegerDigits number
---@field private minimumIntegerDigits number
---@field private maximumFractionDigits number
---@field private minimumFractionDigits number
---@field private roundingMode java.math.RoundingMode
---@field private isFastPath boolean
---@field private fastPathCheckNeeded boolean
...
---@field private MAX_INT_AS_DOUBLE number
---@field private PATTERN_ZERO_DIGIT string
---@field private PATTERN_GROUPING_SEPARATOR string
---@field private PATTERN_DECIMAL_SEPARATOR string
---@field private PATTERN_PER_MILLE string
---@field private PATTERN_PERCENT string
---@field private PATTERN_DIGIT string
---@field private PATTERN_SEPARATOR string
---@field private PATTERN_EXPONENT string
---@field private PATTERN_MINUS string
---@field private CURRENCY_SIGN string
---@field private QUOTE string
---@field private EmptyFieldPositionArray java.text.FieldPosition
